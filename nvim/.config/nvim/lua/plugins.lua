  ...
  },
  {
  ...
  },
    {
        ...
        opts = {
            ...
            -- Context settings
            context = 'buffers', -- Use surrounding buffers for context
            ...
            -- Prompts for code assistance
            prompts = {
                Explain = 'Write an explanation for the active selection as paragraphs of text.',
                Review = 'Review the selected code. Provide concise feedback on potential bugs, code smells, and improvements.',
                ...
                Docs = 'Add documentation comments for the selected code.',
                ...
                Refactor = 'Refactor the code to improve clarity and maintainability.',
            },
        }, 
    },
  { "github/copilot.vim" },
